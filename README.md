...
| Image | Description | Technologies Used | Changes Needed (you might be interested in contributing) |
|-------|-------------|---------------------|-----------------|
|  ![smartbackpack](https://github.com/g-gourav-r/g-gourav-r/assets/75977813/f3b8d72e-d6e4-47b7-94fb-df99c4d9ec75)
<br> [![Smart Backpack](https://img.shields.io/badge/Smart%20Backpack-Click%20to%20Explore-blue)](https://github.com/g-gourav-r/Smart-Carry-Bagpack)(https://github.com/g-gourav-r/the-third-eye)| We wear our backpacks most of the time, but did you know that improper usage of backpacks can lead to severe spinal problems? Smart Carry is a peice of Hardware designed to ensure that carrying your backpack is not a burden on your health. |  **Mobile-Application:** MIT App Inventor  **Back-End:** Arduino Programming ( C++ )  **Hardware:** Arduino, HC-05 Bluetooth Module, FSR Sensors | - Designing a compact aprototype. - Make the monile app more friendly |
